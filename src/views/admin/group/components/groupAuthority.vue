  ...
  <el-row>
    ...
    <el-col :span="16" style="margin-top:15px;">
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column v-if="groupManager_element" type="selection" width="55">
        </el-table-column>
...
<script>
import { fetchTree } from "api/admin/menu/menu";
import { page } from "api/admin/element/element";
import {
...
export default {
  ...
  methods: {
    ...
    handleSelectAllChange (val) {
      ...
      selectAllElementAuthority(this.groupId, {
        menuId: this.currentId,
