<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" fit highlight-current-row
      ...
      <el-table-column align="center" label="最后更新时间" prop="updTime"/>
      <el-table-column align="center" label="最后更新人" prop="updName"/>
      <el-table-column align="center" label="最后更新主机" prop="updHost"/>
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <el-button v-if="groupTypeManager_btn_edit" size="mini" type="success" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button v-if="groupTypeManager_btn_del" size="mini" type="danger" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import {
  ...
  delObj,
  putObj
} from 'api/admin/groupType/groupType';
