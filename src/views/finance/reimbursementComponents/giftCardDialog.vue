<template>
  <div class="fixed_table">
    <!-- giftcard卡费用 输入dialog-->
    <el-dialog title="giftCard费用" :visible.sync="inputDialogVisible" width="90%" :before-close="closeDialog" v-loading="fullScreenLoading" v-dialogDrag top="6vh">
      <el-form :model="giftCardForm" :rules="rules" ref="giftCardForm">
        <el-table class="inputMainClass" :data="giftCardForm.giftCardList" fit highlight-current-row
          ...
          <el-table-column width="80px" align="center" label="付款截图" fixed="left">
          ...
          <el-table-column label="付款截图命名" align="center" width="200px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.paymentScreenshot'" :rules="rules.paymentScreenshot">
          ...
          <el-table-column label="日期" align="center" width="240px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.date'" :rules="rules.date">
          ...
          <el-table-column label="亚马逊订单号" align="center" width="240px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.orderId'" :rules="rules.orderId">
          ...
          <el-table-column label="ASIN" align="center" width="170px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.asin'" :rules="rules.asin">
          ...
          <el-table-column label="SKU" align="center" width="170px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.sku'" :rules="rules.sku">
                <el-input v-model="scope.row.sku" size="mini" placeholder="请输入" @input="changeList(scope.row, 1)"/>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column label="收卡人账号/邮箱" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.payeeName'" :rules="rules.payeeName">
                <el-input v-model="scope.row.payeeName" size="mini" placeholder="请输入" @input="changeList(scope.row, 1)"/>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column label="付卡人账号/邮箱" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.payerName'" :rules="rules.payerName">
          ...
          <el-table-column label="品牌" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.brand'" :rules="rules.brand">
          ...
          <el-table-column label="主管" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.leader'" :rules="rules.leader">
          ...
          <el-table-column label="组别" align="center" width="170px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.team'" :rules="rules.team">
          ...
          <el-table-column label="渠道" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.channel'" :rules="rules.channel">
          ...
          <el-table-column label="国家" align="center" width="100px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.country'" :rules="rules.country">
          ...
          <el-table-column label="review链接" align="center" width="200px" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.link'">
          ...
          <el-table-column label="价格" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.price'" :rules="rules.price">
                <el-input v-model="scope.row.price" size="mini" placeholder="请输入" @input="changeList(scope.row, 1)"/>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column label="价格币种" align="center" width="130px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.priceCurrency'" :rules="rules.priceCurrency">
          ...
          <el-table-column label="佣金" align="center" width="150px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.commission'" :rules="rules.commission">
          ...
          <el-table-column label="佣金币种" align="center" width="130px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.commissionCurrency'" :rules="rules.commissionCurrency">
          ...
          <el-table-column label="汇率" align="center" width="100px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.rate'" :rules="rules.rate">
          ...
          <el-table-column label="总金额(人民币)" align="center" width="160px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.total'" :rules="rules.total">
          ...
          <el-table-column label="备注" align="center" width="200px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.remark'" :rules="rules.remark">
          ...
          <el-table-column label="花费人" align="center" width="160px">
            <template slot-scope="scope">
              <el-form-item :prop="'giftCardList.' + scope.$index + '.applicant'" :rules="rules.applicant">
      ...
      <div v-show="!fullScreenLoading" class="pagination-container">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                       :current-page.sync="getGiftCardForm.page" :page-sizes="[10, 20, 30, 50, 100, 500]" :page-size="getGiftCardForm.limit"
                       layout="total, sizes, prev, pager, next, jumper" :total="giftCardForm.giftCardTotal"/>
      </div>
      <div style="margin-top: 15px;text-align: center">
        ...
        <el-button v-if="selectedRow.claimerId == userId" type="primary" v-waves @click="openImageDialog(5)">上传付款截图</el-button>
        <el-button v-waves @click="closeDialog">取消</el-button>
        <el-button v-if="selectedRow.claimerId == userId" v-waves @click="saveGiftCardDetail">保存</el-button>
      </div>
    </el-dialog>

    <!-- giftCard费用 查询dialog -->
    <el-dialog title="giftCard费用" :visible.sync="queryDialogVisible" width="90%" :before-close="closeDialog" v-loading="fullScreenLoading" v-dialogDrag top="3vh">
      <el-tabs v-model="activeTabName" type="card" @tab-click="handleTabClick">
        <el-tab-pane label="giftCard费用" name="allGiftCards">
          <el-table :data="giftCardForm.giftCardList" ref="giftCardQueryForm" fit highlight-current-row
                    :header-cell-style="{ background: '#f2f2f2', color: '#333',fontSize:'14px'}" :height="tableHeight">
            ...
            <el-table-column label="收卡人账号/邮箱" align="center" width="210px" prop="payeeName" show-overflow-tooltip/>
            <el-table-column label="付卡人账号/邮箱" align="center" width="210px" prop="payerName" show-overflow-tooltip/>
          ...
          <div v-show="!fullScreenLoading" class="pagination-container">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                           :current-page.sync="getGiftCardForm.page" :page-sizes="[10, 20, 30, 50, 100, 500]"
                           :page-size="getGiftCardForm.limit" layout="total, sizes, prev, pager, next, jumper"
                           :total="giftCardForm.giftCardTotal"/>
          </div>
          <div align="center">
            <el-button type="primary" v-waves @click="exportDetail">导出</el-button>
            <el-button v-if="selectedRow.claimerId == userId && selectedRow.status != 5" type="primary" v-waves @click="openImageDialog(5)">上传付款截图</el-button>
        ...
        <el-tab-pane label="订单抽查" name="checkOrder">
          <el-form :model="orderCheckForm" :rules="orderCheckRules" ref="orderCheckForm">
            <el-table :data="orderCheckForm.orderCheckList" ref="orderCheckTable" fit highlight-current-row
              ...
              <el-table-column label="订单截图" align="center" width="80px">
                <template slot-scope="scope">
                  <el-image v-if="scope.row.thumbImgUrl" fit="fill" style="width:33px; height: 33px" :src="scope.row.thumbImgUrl" :preview-src-list="[scope.row.imgUrl]"/>
                </template>
              </el-table-column>
              ...
              <el-table-column label="渠道" align="center" width="150px" prop="channel"/>
              <el-table-column label="国家" align="center" width="100px" prop="country"/>
              <el-table-column label="review链接" align="center" width="130px" prop="link" show-overflow-tooltip/>
              <el-table-column label="价格" align="center" width="100px" prop="price"/>
              <el-table-column label="价格币种" align="center" width="100px" prop="priceCurrency"/>
              <el-table-column label="佣金" align="center" width="100px" prop="commission"/>
              <el-table-column label="佣金币种" align="center" width="100px" prop="commissionCurrency"/>
          ...
          <div align="center" style="margin-top: 10px">
            ...
            <el-button v-if="selectedRow.claimerId == userId && selectedRow.status != 5" type="primary" v-waves @click="openImageDialog(6)">上传订单截图</el-button>
    ...
    <el-dialog title="导入" :visible.sync="importDialogVisible" :before-close="closeImportDialog" v-loading="fullScreenLoading" v-dialogDrag>
      ...
      <div align="center">
        <el-upload style="display: inline-block;margin-left: 10px;margin-right: 10px" ref="uploadFile"
                   action="/api/finance/financeLoanReimbursement/importGiftCardData" name="excel" :headers="headers" :auto-upload='true' :limit="1"
    ...
    <el-dialog title="导入" :visible.sync="importCheckedOrderDialogVisible" :before-close="closeImportCheckedOrderDialog" v-loading="fullScreenLoading" v-dialogDrag>
      ...
      <div align="center">
        <el-upload style="display: inline-block;margin-left: 10px;margin-right: 10px" ref="uploadFile"
                   action="/api/finance/financeLoanReimbursement/importGiftCardCheckedOrder" name="excel" :headers="headers" :auto-upload='true' :limit="1"
    ...
    <!-- giftCard费用 查重dialog-->
    <el-dialog :title="dialogTitle" :visible.sync="duplicateVisible" width="90%" v-loading="fullScreenLoading" v-dialogDrag>
      <div v-if="dialogTitleOptions != undefined && dialogTitle === dialogTitleOptions[1]" align="center">总金额为{{sameImageTotal}}元</div>
      <el-table :data="duplicateGiftCardList" fit highlight-current-row
                :header-cell-style="{ background: '#f2f2f2', color: '#333',fontSize:'14px'}" :height="tableHeight">
        <el-table-column label="#" type="index" align="center" width="65px" fixed="left"/>
        ...
        <el-table-column label="日期" align="center" width="130px" prop="">
          <template slot-scope="scope"><span>{{$moment(scope.row.date).format("YYYY-MM-DD")}}</span></template>
        </el-table-column>
        <el-table-column label="亚马逊订单号" align="center" width="210px" prop="orderId"/>
        <el-table-column label="ASIN" align="center" width="140px" prop="asin"/>
        ...
        <el-table-column label="汇率" align="center" width="100px" prop="rate"/>
        <el-table-column label="总金额" align="center" width="100px" prop="total"/>
        <el-table-column label="备注" align="center" width="200px" prop="remark"/>
        <el-table-column label="自定义备注" align="center" width="200px" prop="customNote" v-if="dialogTitle === dialogTitleOptions[0]"/>
        <el-table-column label="花费人" align="center" width="150px" prop="applicant" v-if="dialogTitle === dialogTitleOptions[0]"/>
        <el-table-column label="报销人" align="center" width="200px" prop="claimerName" v-if="dialogTitle === dialogTitleOptions[0]"/>
        <el-table-column label="来源" align="center" width="150px" prop="source" fixed="right" v-if="dialogTitle === dialogTitleOptions[0]"/>
      </el-table>
    </el-dialog>
    ...
    <el-dialog :title="importErrorTitle" :visible.sync="importErrorDialogVisible" width="90%" v-loading="fullScreenLoading" v-dialogDrag top="6vh">
      <el-table :data="importErrorList" fit highlight-current-row style="width: 100%"
        ...
        <el-table-column width="250px" align="center" label="错误信息" fixed="left" prop="errorMsg"/>
        ...
        <el-table-column width="210px" align="center" label="亚马逊订单号" prop="orderId"/>
        <el-table-column width="140px" align="center" label="asin" prop="asin"/>
        <el-table-column width="140px" align="center" label="sku" prop="sku"/>
        <el-table-column width="150px" align="center" label="收卡人账号/邮箱" prop="payeeName"/>
        <el-table-column width="150px" align="center" label="付卡人账号/邮箱" prop="payerName"/>
        ...
        <el-table-column width="130px" align="center" label="review链接" prop="link" show-overflow-tooltip/>
        ...
        <el-table-column width="100px" align="center" label="总金额" prop="total"/>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          payeeName: [{required: true, message: '请输入收卡人账号/邮箱', trigger: 'blur'}, {max: 64, message: '最大长度为64个字符', trigger: 'blur'}],
          payerName: [{required: true, message: '请输入付卡人账号/邮箱', trigger: 'blur'}, {max: 64, message: '最大长度为64个字符', trigger: 'blur'}],
        ...
        importErrorFrom: '',
        importErrorList: [],
        duplicateGiftCardList: [],
        sameImageTotal: 0,
        dialogTitle: '',
        dialogTitleOptions: ['重复的giftCard费用','相同付款截图的giftCard费用'],
        tableHeight: undefined,
        uploadImageType: undefined,
        activeTabName: 'allGiftCards',
        imgList: []
      }
    },
    mixins: [mixins],
    watch: {
      visible(val) {
        ...
        if (this.selectedRow.status == -1 || this.selectedRow.status == 0) {
          ...
          this.activeTabName = 'allGiftCards';
      ...
      dialogVisible(val) {
        if (val === false) {
          this.giftCardForm = {reimbursementId: this.selectedRow.id, giftCardList: [], changeList: [], deleteList: [], giftCardTotal: undefined};
        }
        this.$emit('change-gift-card-visible', val);
      },
    ...
    methods: {
      changeList(row, type) {
        ...
        let changeList;
        if (type === 1) {
          changeList = this.giftCardForm.changeList;
        } else if (type === 2) {
      ...
      deleteList(row) {
        let form = this.giftCardForm;
        let list = this.giftCardForm.giftCardList;
      ...
      getGiftCardDetail() {
        this.getGiftCardForm.reimbursementId = this.selectedRow.id;
        this.getGiftCardForm.type = 3;
        this.fullScreenLoading = true;
        getReimbursementItemDetail(this.getGiftCardForm).then(response => {
          this.giftCardForm.giftCardList = response.data.rows;
          this.giftCardForm.giftCardTotal = response.data.total;
          this.sortIndex(1);
      ...
      clearDetail() {
        this.$confirm("是否清空费用明细?", "清空确认", {
          ...
          this.fullScreenLoading = true;
          let form = {type: 4, reimbursementId: this.selectedRow.id};
      ...
      handleSizeChange(val) {
        this.getGiftCardForm.limit = val;
        this.getGiftCardDetail();
      },
      handleCurrentChange(val) {
        this.getGiftCardForm.page = val;
        this.getGiftCardDetail();
      },
      addFormColumn() {
        this.giftCardForm.giftCardList.push({});
        this.sortIndex(1);
      },
      sortIndex(type) {
        let list;
        if (type === 1) {
          list = this.giftCardForm.giftCardList;
        } else if (type === 2) {
      ...
      downloadTemplate() {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = ['日期', '亚马逊订单号', 'ASIN', 'SKU', '收卡人账号/邮箱', '付卡人账号/邮箱', '品牌', '主管', '组别', '渠道', '国家', 'review链接', '价格', '价格币种', '佣金', '佣金币种', '汇率', '总金额(人民币)', '备注', '花费人', '付款截图命名'];
          const data = [];
          excel.export_json_to_excel({
            header: tHeader,
            data,
            filename: 'giftCardTemplate',
            autoWidth: true,
            bookType: 'xlsx'
          });
          this.fullScreenLoading = false;
      ...
      saveGiftCardDetail() {
        this.$refs['giftCardForm'].validate(valid => {
          if (valid) {
            this.fullScreenLoading = true;
            this.giftCardForm.reimbursementId = this.selectedRow.id;
            saveGiftCardDetail(this.giftCardForm).then(response => {
              if (response.resCode === 200) {
                this.$message.success("保存成功");
                this.giftCardForm.changeList = [];
                this.giftCardForm.deleteList = [];
              } else {
      ...
      sumTotal(rule, value, callback) {
        ...
        let row = this.$refs.giftCardForm.model.giftCardList[index];
        if (row.price == undefined || row.priceCurrency == undefined ||
          row.commission == undefined || row.commissionCurrency == undefined || row.rate == undefined) {
          callback(new Error('未填写价格、佣金、币种及汇率'));
        } else {
          let total = 0;
          if (row.priceCurrency.toUpperCase() == 'CNY') {
            total += Number(row.price);
          } else {
            total += Number(row.price) * Number(row.rate);
          }
          if (row.commissionCurrency.toUpperCase() == 'CNY') {
      ...
      openImageDialog(type) {
        // uploadImageType 1:review付款截图,2:非review付款截图，3:review订单截图,4:评价帮订单截图,5:giftCard付款截图，6: giftCard订单截图
      ...
      getCheckedOrder() {
        // type 类型 1.review订单抽查 2评价帮订单抽查，3 giftCard
      ...
      getFeeSubtract() {
        // type 类型，1 review ，2 非review, 3 评价帮, 4 giftCard
        let form = {reimbursementId: this.selectedRow.id, type: 4};
        this.fullScreenLoading = true;
      ...
      viewSameImage(row) {
        ...
        //type 类型 1 review 2非review 3 giftCard
        let query = {
        ...
        findSameImageDetail(query).then(response => {
          if (response.resCode === 200) {
            this.duplicateGiftCardList = response.data;
            this.sameImageTotal = 0;
            for (let i = 0, length = this.duplicateGiftCardList.length; i <= length - 1; i++) {
              this.sameImageTotal += this.duplicateGiftCardList[i].total;
            }
      ...
      viewDuplicateDetail(row) {
        ...
        // type 类型，1 review, 2 评价帮, 3 giftCard
        let query = {
          type: 3,
          id: row.id,
          reimbursementId: row.reimbursementId,
      ...
      addCheckedOrder() {
        let selection = this.$refs.giftCardQueryForm.selection;
      ...
      addFeeSubtract(type) {
        let selection;
        // type 1 giftCard费用页面 2订单抽查页面
        if (type === 1) {
          selection = this.$refs.giftCardQueryForm.selection;
        } else if (type === 2) {
        ...
        // type 类型，1 review ，2 非review ，3 评价帮 ， 4 giftCard
        let form = {type: 4, feeSubtractList: feeSubtractList};
      ...
      async exportDetail() {
        ...
        const res = await exportByReimbursementId({type: 3, reimbursementId: this.selectedRow.id}).catch(() => loading.close());
      ...
      async exportCheckedOrder() {
        ...
        const res = await exportCheckedOrder({type: 3, reimbursementId: this.selectedRow.id}).catch(() => loading.close());
        if(res.data.type === 'application/json') {
          // 导出报错
          loading.close();
          const reader = new FileReader();
      ...
      async exportFeeSubtract() {
        ...
        const res = await exportFeeSubtract({type: 4, reimbursementId: this.selectedRow.id}).catch(() => loading.close());
        if(res.data.type === 'application/json') {
          // 导出报错
          loading.close();
          const reader = new FileReader();
      ...
      saveCheckedReviewDetail() {
        this.$refs['orderCheckForm'].validate(valid => {
          if (valid) {
            this.fullScreenLoading = true;
            saveGiftCardDetail(this.orderCheckForm).then(response => {
              if (response.resCode === 200) {
                this.$message.success("保存成功");
              } else {
                this.importErrorTitle = '保存失败';
      ...
      cancelFeeSubtract(row) {
        ...
        row.subtractRemark = '';
        // type 类型，1 review ，2 非review，3 评价帮, 4 giftCard
        let form = {feeSubtractList: [row], type: 4};
      ...
      confirmFeeSubtract() {
        ...
        let form = {
          // type 扣减类型，1 review，2 非review，3评价帮, 4 giftCard
          type: 4,
      ...
      saveFeeSubtract() {
        this.fullScreenLoading = true;
        // type 类型，1 review ，2 ，3 评价帮, 4 giftCard
        let form = {feeSubtractList: this.feeSubtractForm.feeSubtractList, type: 4};
        updateFeeSubtract(form).then(response => {
          if (response.resCode === 200) {
            this.$message.success("保存成功");
          } else {
