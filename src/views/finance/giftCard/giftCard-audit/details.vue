<template>
  <div class="appGift">
    <el-dialog  :visible.sync="dialogTableVisible" width="60%">
      <div slot="title" class="title flex">
        ...
        <el-tooltip placement="bottom">
          <div slot="content">所有的额度指的是人民币额度。<br/>
            每次申请不同币种的 Gift Card 金额都会<br/>根据财务所配置的汇率转化成人民币的，<br/>
            并在可用额度中减去想要金额的额度。<br/>额度的实际大小会随着财务对<br/>汇率的调整而变化。
            一般而言，财务每<br/>月月初更新一次汇率。</div>
            <div>
      ...
      <div class="flex">
        ...
        <span>本次预计使用额度：<span style="color:#37c4a8">￥{{applyTotal.toFixed(2)}}</span> </span>
      </div>
      <div class="table">
         <el-table
          v-loading="loading"
    ...
    <el-dialog title="Gift Card领用详情" :visible.sync="conditionVisible" width="45%">
      <div class="flex">
        <span></span>
        <span> <span>总计：{{amount}}张</span> 已经领用：<span style="color:#37c4a8">{{useAmount}}张</span> </span>
      </div>
      <div class="table">
         <el-table
          v-loading="dbloading"
